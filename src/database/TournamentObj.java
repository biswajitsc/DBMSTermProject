...
public class TournamentObj {
    ...
    String generatequery()
    {
        ...
        if(winner != null) query += "and Winner = \"" + winner +"\" ";
        if(runs_high != null) query += "and Total_Runs <= " + runs_high + " ";
        if(runs_low != null) query += "and Total_Runs >= " + runs_low + " ";
        if(wickets_high != null) query += "and Total_Wickets <= " + wickets_high + " ";
        if(wickets_low != null) query += "and Total_Wickets >= " + wickets_low + " ";
        if(balls_high != null) query += "and Total_Balls <= " + balls_high + " ";
        if(balls_low != null) query += "and Total_Balls >= " + balls_low + " ";
